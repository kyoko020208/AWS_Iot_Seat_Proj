...
class NoSQLQueryResultViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "showMap" {
            var SeatViewController = segue.destination as! SeatViewController
            SeatViewController.results2 = String("\(modelDictionary["_value"]!)")
            print("\(results?[0])+aaa")
            print("\(model!.dictionaryValue)+bbb")
            print("\(modelDictionary["_value"]!)+ccc")
        }
    }
